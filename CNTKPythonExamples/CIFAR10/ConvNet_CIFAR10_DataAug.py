...
if __name__=='__main__':
    ...
    # may load data
    if not os.path.exists(os.path.join(data_path, 'train_map.txt')) or \
       not os.path.exists(os.path.join(data_path, 'CIFAR-10_mean.xml')) or \
       not os.path.exists(os.path.join(data_path, 'test_map.txt')) :
        ic.loadData(data_path)
